 ...
 * @author iUser
 */
public class SerClient extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String Active = request.getParameter("estado");
        Cliente clint = new Cliente(name, phone, address, Active);
        DAO.DaoCliente.add(clint);
